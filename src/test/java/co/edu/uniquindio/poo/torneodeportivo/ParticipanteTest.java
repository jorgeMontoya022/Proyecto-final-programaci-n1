...
public class ParticipanteTest {
    ...
    public void registrarParticipanteTorneo() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, CaracterTorneo.INDIVIDUAL, TorneoGenero.MIXTO);
    ...
    public void registrarParticipanteIndividualTorneoGrupal() {
        ...
        var jugador = new Jugador("Laura","Garcia","lauragarcia@email.com","6067431234",LocalDate.now().minusYears(15), null);
