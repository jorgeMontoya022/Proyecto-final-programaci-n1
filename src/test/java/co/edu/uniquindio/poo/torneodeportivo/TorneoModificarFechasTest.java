...
public class TorneoModificarFechasTest {
    ...
    public void modificarFechaInicio() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 8, 1), LocalDate.of(2023, 9, 15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL, TorneoGenero.MIXTO, CaracterTorneo.GRUPAL);
    ...
    public void modificarFechaInicioNull() {
        ...
        // Almacenar los datos de prueba Copa Mundo|2023-10-01|2023-08-01|2023-09-15|24|0|0|LOCAL|GRUPAL
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 8, 1), LocalDate.of(2023, 9, 15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL, TorneoGenero.FEMENINO, CaracterTorneo.GRUPAL);
    ...
    public void modificarFechaInicioAnteriorInscripciones() {
        ...
        // Almacenar los datos de prueba Copa Mundo|2023-10-01|2023-08-01|2023-09-15|24|0|0|LOCAL|GRUPAL
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 8, 1), LocalDate.of(2023, 9, 15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL, TorneoGenero.MASCULINO, CaracterTorneo.GRUPAL);
