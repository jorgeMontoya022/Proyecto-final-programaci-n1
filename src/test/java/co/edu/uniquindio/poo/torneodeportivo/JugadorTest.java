...
public class JugadorTest {
    ...
    public void registrarJugadorTorneo() {
        ...
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL|FEMENINO|GRUPAL}  Equipo{UniquindioFEM} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Laura,Garcia,lauragarcia@email.com,6067431234, fechaActual - 15 años}

        
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, TorneoGenero.FEMENINO, CaracterTorneo.GRUPAL);
    ...
    public void registrarJugadorTorneoSinLimiteEdad() {
        ...
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual+15 días\|24\|0\|0\|LOCAL|MASCULINO|GRUPAL}  Equipo{UniquindioMasculino} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Christian,Candela,chrcandela@email.com,6038917552, fechaActual - 21 años}

        
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL, TorneoGenero.MASCULINO, CaracterTorneo.GRUPAL);

        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("UniquindioMasculino", representante);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6038917552",LocalDate.now().minusYears(21));
    ...
    public void registrarJugadorTorneoConLimiteEdad() {
        ...
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL|MIXTO|GRUPAL}  Equipo{Uniquindio} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Ana,Ruiz,anaruiz@email.com,6073861062, fechaActual - 21 años}

        
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, TorneoGenero.MIXTO, CaracterTorneo.GRUPAL);
    ...
    public void registrarJugadorTorneoInscripcionesCerradas() {
        ...
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual-1 día\|24\|18\|0\|LOCAL|MIXTO|GRUPAL}  Equipo{Uniquindio} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300} Jugador {Ana,Ruiz,anaruiz@email.com,6073861062, fechaActual - 15 años}

        
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(1), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, TorneoGenero.MIXTO, CaracterTorneo.GRUPAL);
    ...
    public void registrarJugadoresRepetidosTorneo() {
        ...
        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("UniquindioFEM", representante);
        var equipo2 = new Equipo("QuindíoFEM", representante);
        torneo.registrarParticipante(equipo);
        torneo.registrarParticipante(equipo2);

        var jugador = new Jugador("Laura", "Garcia", "lauragarcia@email.com", "6067431234",LocalDate.now().minusYears(15));
        var jugador2 = new Jugador("Laura", "Garcia", "lauragarcia@email.com", "6067431234",LocalDate.now().minusYears(15));
    ...
    public void registrarJugadorGeneroNoPermitido(){
         var torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, TorneoGenero.MASCULINO, CaracterTorneo.GRUPAL);

         var representante = new Persona("Daniel", "Cubillos", "dCubillos@email.com", "6067359300");
